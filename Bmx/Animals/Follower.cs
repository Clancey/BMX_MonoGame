...
namespace GameStateManagement
{
    class Follower : Animal
    {
        ...
        public Follower(Texture2D tex, Vector2 dir, Vector2 loc, 
            ...
            : base(tex, screenWidth, screenHeight)
        {
            ...
            animaltype = AnimalType.Follower;
            BuildBehaviors();
        }
        #endregion
        ...
        public override void Draw(SpriteBatch spriteBatch, GameTime gameTime)
        {
			...
			switch (animalState) {
				case AnimalState.Fleeing :
	                ...
	                t = (float)Math.Sin(10 * gameTime.TotalGameTime.TotalSeconds);
        ...
        {
            AnimalState = AnimalState.Following;
